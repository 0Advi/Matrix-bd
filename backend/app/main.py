...
from app.routers import audit, auth, bd, delegations, loi, notifications, sites, staging, supervisor_codes, tenancy, users
...
for router_module in (auth, bd, loi, staging, sites, audit, notifications, tenancy, users, delegations, supervisor_codes):
