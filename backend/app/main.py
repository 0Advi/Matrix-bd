...
from app.routers import audit, auth, bd, business_admin, delegations, design, legal, loi, notifications, sites, staging, supervisor_codes, tenancy, users
...
for router_module in (auth, bd, legal, design, loi, staging, sites, audit, notifications, tenancy, users, delegations, business_admin, supervisor_codes):
